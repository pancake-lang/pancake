...
{
	if (region.aE.b8 === region.aW.b8)
	{
		return 'on line ' + region.aE.b8;
	}
	return 'on lines ' + region.aE.b8 + ' through ' + region.aW.b8;
}
...
var $author$project$Main$initModel = {F: $author$project$Editor$Main$init, S: false, bd: $elm$core$Maybe$Nothing, O: $elm$core$Maybe$Nothing};
...
var $author$project$Language$Machine$init = F2(
	function (code, labels) {
		return {
			...
			ab: $author$project$Language$Stack$empty,
			aF: $elm$core$Result$Ok(0),
			bG: 0
		};
	});
...
var $author$project$Language$Machine$Instruction = F3(
	function (line, world, value) {
		return {b8: line, cB: value, bG: world};
	});
...
var $author$project$Language$Compiler$compile = function (ast) {
	var noNotes = $elm$core$Array$fromList(
		A2(
			...
			function (astLine) {
				return !$author$project$Language$Parser$isNote(astLine.aj);
			},
			ast));
		...
		$elm_community$maybe_extra$Maybe$Extra$values(
			$elm$core$Array$toList(
				A2(
					...
					F2(
						function (id, astLine) {
							return $author$project$Language$Parser$isLabel(astLine.aj) ? $elm$core$Maybe$Just(
								_Utils_Tuple2(
									A2(
										$elm$core$Maybe$withDefault,
										'',
										$author$project$Language$Parser$getLabel(astLine.aj)),
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {aS: col, bS: contextStack, bh: problem, bq: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.bq, s.aS, x, s.e));
	});
...
var $elm$parser$Parser$Advanced$chompUntilEndOr = function (str) {
	return function (s) {
		var _v0 = A5(_Parser_findSubString, str, s.b, s.bq, s.aS, s.a);
		var newOffset = _v0.a;
		var newRow = _v0.b;
		var newCol = _v0.c;
		...
		return A3(
			...
			0,
			{aS: newCol, e: s.e, g: s.g, b: adjustedOffset, bq: newRow, a: s.a});
	};
};
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.bq, s.aS, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{aS: newCol, e: s.e, g: s.g, b: newOffset, bq: newRow, a: s.a});
	};
};
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{aS: col, e: s0.e, g: s0.g, b: offset, bq: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.bq, s.aS, s);
	};
};
...
var $elm$parser$Parser$Advanced$bumpOffset = F2(
	function (newOffset, s) {
		return {aS: s.aS + (newOffset - s.b), e: s.e, g: s.g, b: newOffset, bq: s.bq, a: s.a};
	});
	...
	function (invalid, expecting, intSettings, floatSettings, intPair, s) {
		...
		if (floatOffset < 0) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				true,
				A4($elm$parser$Parser$Advanced$fromInfo, s.bq, s.aS - (floatOffset + s.b), invalid, s.e));
		} else {
...
var $elm$parser$Parser$Advanced$chompUntil = function (_v0) {
	...
	var expecting = _v0.b;
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$findSubString, str, s.b, s.bq, s.aS, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {aS: col, bh: problem, bq: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.bq, p.aS, p.bh);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{aS: 1, e: _List_Nil, g: 1, b: 0, bq: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $author$project$Main$checkSourceAndUpdate = function (model) {
	var parsed = $author$project$Language$Parser$parse(model.F.aa);
	var editor = A2(
...
var $author$project$Language$Machine$panic = F2(
	function (error, machine) {
		return _Utils_update(
			machine,
			{
				aF: $elm$core$Result$Err(error)
			});
	});
...
var $author$project$Language$Machine$toInt = function (value) {
	if (value.$ === 1) {
		var _int = value.a;
	...
	return $elm$core$Array$fromList(
		$elm_community$maybe_extra$Maybe$Extra$values(
			A2(
				...
				A2($elm$core$List$take, 2, machine.ab))));
};
...
var $author$project$Language$Core$popN = F2(
	function (argc, machine) {
		return _Utils_update(
			machine,
			{
				ab: A2($elm$core$List$drop, argc, machine.ab)
			});
	});
...
var $author$project$Language$Machine$push = F2(
	function (value, machine) {
		return _Utils_update(
			machine,
			{
				ab: A2($author$project$Language$Stack$push, value, machine.ab)
			});
	});
var $author$project$Language$Core$wrongArgCount = $author$project$Language$Machine$panic('wrong number of arguments in function call');
var $author$project$Language$Core$binOp = F2(
	function (func, machine) {
		...
		return ($elm$core$Array$length(args) !== 2) ? $author$project$Language$Core$wrongArgCount(machine) : A2(
			$author$project$Language$Machine$push,
			$author$project$Language$Machine$Int(
				A2(func, x, y)),
			A2($author$project$Language$Core$popN, 2, machine));
	});
var $author$project$Language$Machine$asBool = A2(
	$elm$core$Basics$composeR,
	$author$project$Language$Machine$toInt,
	$elm$core$Maybe$map(
...
var $author$project$Language$World$flip = function (world) {
	if (!world) {
		return 1;
	} else {
		return 0;
...
var $author$project$Language$Core$flip_ = function (machine) {
	return _Utils_update(
		machine,
		{
			bG: $author$project$Language$World$flip(machine.bG)
		});
};
...
var $author$project$Language$Core$flipIfTrue = function (machine) {
	var arg = $elm$core$List$head(machine.ab);
	if (!arg.$) {
		var value = arg.a;
		var _v1 = $author$project$Language$Machine$asBool(value);
		if (!_v1.$) {
			if (_v1.a) {
				return $author$project$Language$Core$flip_(
					A2($author$project$Language$Core$popN, 1, machine));
			} else {
				return A2($author$project$Language$Core$popN, 1, machine);
			}
		} else {
			return A3(
				...
				machine,
				A2($author$project$Language$Machine$combine, 'flip expected a boolean', 'type error'));
		}
	} else {
		return $author$project$Language$Core$wrongArgCount(machine);
	}
};
var $author$project$Language$Core$not_ = function (bool) {
	if (!bool) {
		return 1;
	} else {
		return 0;
...
var $author$project$Language$Core$unOpArg = function (machine) {
	return A2(
		$elm$core$Maybe$andThen,
		$author$project$Language$Machine$toInt,
		$elm$core$List$head(machine.ab));
};
var $author$project$Language$Core$unOp = F2(
	function (func, machine) {
		var _v0 = $author$project$Language$Core$unOpArg(machine);
		if (_v0.$ === 1) {
			return $author$project$Language$Core$wrongArgCount(machine);
		} else {
			var x = _v0.a;
...
var $author$project$Language$Core$lib = $elm$core$Dict$fromList(
	_List_fromArray(
		[
			...
			_Utils_Tuple2(
			'not',
			$author$project$Language$Core$unOp($author$project$Language$Core$not_)),
			_Utils_Tuple2('flip', $author$project$Language$Core$flip_),
			_Utils_Tuple2('flip if true', $author$project$Language$Core$flipIfTrue),
			_Utils_Tuple2(
			'flip if false',
			A2(
				$elm$core$Basics$composeR,
				$author$project$Language$Core$unOp($author$project$Language$Core$not_),
				$author$project$Language$Core$flipIfTrue)),
			_Utils_Tuple2(
			'+',
...
var $author$project$Language$Runtime$name = function (id) {
	var _v0 = $author$project$Language$Core$lookup(id);
	if (!_v0.$) {
		var command = _v0.a;
		return command;
	} else {
...
var $author$project$Language$Runtime$skipOnWorldMismatch = F2(
	function (instruction, machine) {
		return (!_Utils_eq(instruction.bG, machine.bG)) ? $author$project$Language$Machine$skip(machine) : $author$project$Language$Machine$skip(
			A2($author$project$Language$Runtime$exec, instruction, machine));
	});
var $author$project$Language$Runtime$step = function (machine) {
	var currentInstruction = A2($elm$core$Array$get, machine.ai, machine.aR);
	if (currentInstruction.$ === 1) {
		return A2($author$project$Language$Machine$panic, 'failed to fetch instruction', machine);
	} else {
		var instruction = currentInstruction.a;
		return A2($author$project$Language$Runtime$skipOnWorldMismatch, instruction, machine);
	}
};
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							bd: $author$project$Editor$Main$isSourceChange(editorMsg) ? $elm$core$Maybe$Nothing : model.bd
						}),
			...
			case 2:
				return _Utils_Tuple2(
					$author$project$Main$checkSourceAndUpdate(model),
					$elm$core$Platform$Cmd$none);
			case 3:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							O: A2($elm$core$Maybe$map, $author$project$Language$Runtime$step, model.O)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				var event = msg.a;
				return A2($author$project$Main$updateOnKeyBinding, event, model);
		}
	});
...
var $icidasset$elm_material_icons$Material$Icons$Outlined$flaky = A2(
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$svg$Svg$Attributes$d('M14.05,17.58l-0.01,0.01l-2.4-2.4l1.06-1.06l1.35,1.35L16.54,13l1.06,1.06 l-3.54,3.54L14.05,17.58z M12,2C6.5,2,2,6.5,2,12s4.5,10,10,10s10-4.5,10-10S17.5,2,12,2z M7.34,6.28l1.41,1.41l1.41-1.41 l1.06,1.06L9.81,8.75l1.41,1.41l-1.06,1.06L8.75,9.81l-1.41,1.41l-1.06-1.06l1.41-1.41L6.28,7.34L7.34,6.28z M12,20 c-2.2,0-4.2-0.9-5.7-2.3L17.7,6.3C19.1,7.8,20,9.8,20,12C20,16.4,16.4,20,12,20z'),
	...
	if (((_v0.b && _v0.b.b) && (!_v0.b.a.$)) && _v0.b.b.b) {
		...
		return $elm$core$Maybe$Just(
			A2(
				...
				true,
				{
					as: A2($elm$core$String$left, 1, fence),
					at: $elm$core$String$length(fence),
					o: A2(
						$elm$core$Maybe$withDefault,
						0,
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$matchToInline = function (_v0) {
	...
	switch (_v1.$) {
		case 0:
			return $pablohirafuji$elm_markdown$Markdown$Inline$Text(match.aI);
		case 1:
			return $pablohirafuji$elm_markdown$Markdown$Inline$HardLineBreak;
		case 2:
			return $pablohirafuji$elm_markdown$Markdown$Inline$CodeInline(match.aI);
		case 3:
			var _v2 = _v1.a;
			var text = _v2.a;
			var url = _v2.b;
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$prepareChildMatch = F2(
	function (parentMatch, childMatch) {
		return _Utils_update(
			childMatch,
			{aW: childMatch.aW - parentMatch.C, aE: childMatch.aE - parentMatch.C, U: childMatch.U - parentMatch.C, C: childMatch.C - parentMatch.C});
	});
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$organizeMatch = F2(
	function (_v0, matches) {
		...
		if (!matches.b) {
			...
			return (_Utils_cmp(prevMatch.aW, match.aE) < 1) ? A2($elm$core$List$cons, match, matches) : (((_Utils_cmp(prevMatch.aE, match.aE) < 0) && (_Utils_cmp(prevMatch.aW, match.aW) > 0)) ? A2(
				$elm$core$List$cons,
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$normalMatch = function (text) {
	return {
		...
		c: _List_Nil,
		aE: 0,
		aI: $pablohirafuji$elm_markdown$Markdown$Helpers$formatStr(text),
		U: 0,
		C: 0,
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$parseTextMatch = F3(
	function (rawText, _v2, parsedMatches) {
		...
		var updtMatch = _Utils_update(
			matchModel,
			{
				c: A3($pablohirafuji$elm_markdown$Markdown$InlineParser$parseTextMatches, matchModel.aI, _List_Nil, matchModel.c)
			});
		if (!parsedMatches.b) {
			...
			return _Utils_eq(matchHead.ae, $pablohirafuji$elm_markdown$Markdown$InlineParser$NormalType) ? A2($elm$core$List$cons, updtMatch, parsedMatches) : (_Utils_eq(matchModel.aW, matchHead.aE) ? A2($elm$core$List$cons, updtMatch, parsedMatches) : ((_Utils_cmp(matchModel.aW, matchHead.aE) < 0) ? A2(
				$elm$core$List$cons,
				updtMatch,
				A2(
					$elm$core$List$cons,
					$pablohirafuji$elm_markdown$Markdown$InlineParser$normalMatch(
						A3($elm$core$String$slice, matchModel.aW, matchHead.aE, rawText)),
		...
		while (true) {
			if (!matches.b) {
				if (!parsedMatches.b) {
					...
					return (matchModel.aE > 0) ? A2(
						$elm$core$List$cons,
						$pablohirafuji$elm_markdown$Markdown$InlineParser$normalMatch(
							A2($elm$core$String$left, matchModel.aE, rawText)),
						parsedMatches) : parsedMatches;
				}
			} else {
				var match = matches.a;
			...
			h: A2(
				...
				_Utils_ap(
					...
					_Utils_ap(
						...
						_Utils_ap(
							A2($pablohirafuji$elm_markdown$Markdown$InlineParser$findHardBreakTokens, model.cq.bx, model.s),
							_Utils_ap(
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$autolinkToMatch = function (_v0) {
	var match = _v0;
	return A2($elm$regex$Regex$contains, $pablohirafuji$elm_markdown$Markdown$InlineParser$urlRegex, match.aI) ? $elm$core$Result$Ok(
		_Utils_update(
			match,
			{
				ae: $pablohirafuji$elm_markdown$Markdown$InlineParser$AutolinkType(
					_Utils_Tuple2(
						match.aI,
						$pablohirafuji$elm_markdown$Markdown$InlineParser$encodeUrl(match.aI)))
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$refRegexToMatch = F3(
	function (matchModel, model, maybeRegexMatch) {
		...
		var refLabel = function (str) {
			return $elm$core$String$isEmpty(str) ? matchModel.aI : str;
		}(
			A2(
				$elm$core$Maybe$withDefault,
				matchModel.aI,
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$checkParsedAheadOverlapping = function (parser) {
	...
	if (!_v0.b) {
		...
		var overlappingMatches = A2(
			...
			function (_v1) {
				var testMatch = _v1;
				return (_Utils_cmp(match.aW, testMatch.aE) > 0) && (_Utils_cmp(match.aW, testMatch.aW) < 0);
			},
			remainMatches);
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$emailAutolinkTypeToMatch = function (_v0) {
	var match = _v0;
	return A2($elm$regex$Regex$contains, $pablohirafuji$elm_markdown$Markdown$InlineParser$emailRegex, match.aI) ? $elm$core$Result$Ok(
		_Utils_update(
			match,
			{
				ae: $pablohirafuji$elm_markdown$Markdown$InlineParser$AutolinkType(
					_Utils_Tuple2(
						match.aI,
						'mailto:' + $pablohirafuji$elm_markdown$Markdown$InlineParser$encodeUrl(match.aI)))
			})) : $elm$core$Result$Err(match);
};
	...
	function (model, _v0) {
		...
		if (_v1.$ === 2) {
			...
			return A2(
				...
				$elm$core$List$head(
					A3($elm$regex$Regex$findAtMost, 1, $pablohirafuji$elm_markdown$Markdown$InlineParser$htmlRegex, match.aI)));
		}
	});
var $pablohirafuji$elm_markdown$Markdown$InlineParser$isCloseToken = F2(
	function (htmlModel, token) {
		...
		if ((_v0.$ === 5) && (!_v0.a)) {
			...
			return _Utils_eq(htmlModel.aH, htmlModel_.aH);
		} else {
			return false;
		}
	});
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$isVoidTag = function (htmlModel) {
	return A2($elm$core$List$member, htmlModel.aH, $pablohirafuji$elm_markdown$Markdown$InlineParser$voidHtmlTags);
};
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$tokenToMatch = F2(
	function (token, type_) {
		return {aW: token.b3 + token.d, c: _List_Nil, aE: token.b3, aI: '', U: 0, C: 0, ae: type_};
	});
var $pablohirafuji$elm_markdown$Markdown$InlineParser$lineBreakTTM = function (_v0) {
	...
	while (true) {
		...
		if (!tokens.b) {
			...
			if (_Utils_eq(token.f, $pablohirafuji$elm_markdown$Markdown$InlineParser$HardLineBreakToken) || (_Utils_eq(token.f, $pablohirafuji$elm_markdown$Markdown$InlineParser$SoftLineBreakToken) && model.cq.bx)) {
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$emphasisToMatch = F4(
	function (closeToken, tokensTail, model, _v15) {
		...
		var updt = (!remainLength) ? {ah: closeToken, Y: openToken, am: remainTokens, ao: tokensTail} : ((remainLength > 0) ? {
			ah: closeToken,
			Y: _Utils_update(
				openToken,
...
var $pablohirafuji$elm_markdown$Markdown$Block$dropRefString = F2(
	function (rawText, inlineMatch) {
		var strippedText = A2($elm$core$String$dropLeft, inlineMatch.aw, rawText);
...
var $pablohirafuji$elm_markdown$Markdown$Block$insertLinkMatch = F2(
	function (refs, linkMatch) {
		return A2($elm$core$Dict$member, linkMatch.L, refs) ? refs : A3(
			$elm$core$Dict$insert,
			linkMatch.L,
			_Utils_Tuple2(linkMatch.ap, linkMatch.ax),
			refs);
	});
var $pablohirafuji$elm_markdown$Markdown$Block$extractUrlTitleRegex = function (regexMatch) {
	...
	if ((((((_v0.b && (!_v0.a.$)) && _v0.b.b) && _v0.b.b.b) && _v0.b.b.b.b) && _v0.b.b.b.b.b) && _v0.b.b.b.b.b.b) {
		...
		var toReturn = function (rawUrl) {
			return {
				L: rawText,
				aw: $elm$core$String$length(regexMatch.b9),
				ax: $pablohirafuji$elm_markdown$Markdown$Helpers$returnFirstJust(
					_List_fromArray(
						[maybeTitleSingleQuotes, maybeTitleDoubleQuotes, maybeTitleParenthesis])),
				ap: rawUrl
			};
...
var $pablohirafuji$elm_markdown$Markdown$Block$maybeLinkMatch = function (rawText) {
	return A2(
		$elm$core$Maybe$andThen,
		function (linkMatch) {
			return ((linkMatch.ap === '') || (linkMatch.L === '')) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(linkMatch);
		},
		A2(
			$elm$core$Maybe$map,
			function (linkMatch) {
				return _Utils_update(
					linkMatch,
					{
						L: $pablohirafuji$elm_markdown$Markdown$Helpers$prepareRefLabel(linkMatch.L)
					});
			},
			A2(
				$elm$core$Maybe$andThen,
...
var $author$project$Terminal$Class$stack = $author$project$Terminal$Class$terminal('stack');
var $author$project$Terminal$Class$stackFrame = $author$project$Terminal$Class$terminal('stack-frame');
...
var $author$project$Editor$Main$view = function (model) {
	var numberOfLines = $elm$core$List$length(
		$elm$core$String$lines(model.aa));
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$section,
						_List_fromArray(
							[$author$project$Terminal$Class$stack]),
						stack_)
					]))
			]);
	}();
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$title('Hide help')
					]),
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$title('Check code')
					]),
				checkResult),
				A2(
				$author$project$Icon$map,
				...
				_List_fromArray(
					[
						$author$project$Navigation$Class$icon,
						$elm$html$Html$Events$onClick($author$project$Main$ToggleHelp),
						$elm$html$Html$Attributes$title('Show help')
					]),
